...
주요 상태는 [app/page.tsx](app/page.tsx)에 존재하며 props를 통해 하위로 전달됩니다:
...
- 클린업 시 blob URL을 해제해야 함 ([components/ply-loader.tsx:40-41](components/ply-loader.tsx#L40-L41) 참조)
...
프로젝트 루트 디렉토리를 가리키는 `@/*` 별칭을 사용 ([tsconfig.json](tsconfig.json#L21-L23)에서 설정)

## UI 컴포넌트

프로젝트는 shadcn/ui 컴포넌트 (Radix UI + Tailwind)를 사용합니다. 컴포넌트 정의는 [components/ui/](components/ui/)에 있으며, 설정은 [components.json](components.json)에 있습니다.
